...
urlpatterns = [
    ...
    path('get-book-slot-times/<int:slot_id>/', get_book_times_for_day, name='book_slot'),
    path('book-slot/<int:slot_id>/', book_slot, name='book_slot'),
    path('cancel-booked-slot/<int:slot_id>/', cancel_slot, name='cancel_booked_slot'),
    path('update-booked-slot/<int:slot_id>/', update_slot, name='update_booked_slot'),
]
