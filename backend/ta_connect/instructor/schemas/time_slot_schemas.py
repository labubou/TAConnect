...
add_time_slot_request = openapi.Schema(
    ...
    properties={
        ...
        'start_date': openapi.Schema(type=openapi.TYPE_STRING, format='date', description='Start date of office hours', example='2025-01-15'),
        'end_date': openapi.Schema(type=openapi.TYPE_STRING, format='date', description='End date of office hours', example='2025-05-15'),
