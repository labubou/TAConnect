          ...
          <div className={`rounded-2xl ${isDark ? 'bg-gray-800' : 'bg-white'} shadow-lg border ${isDark ? 'border-gray-700' : 'border-gray-100'} p-4 sm:p-6`}>
            <div className="flex items-start justify-between gap-4">
              ...
              >
                ...
                <span className="text-sm font-medium hidden sm:inline">Reset to Default</span>
              </button>
            </div>
          </div>
              ...
              <div className="flex items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p className={`text-sm mt-1 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                    Get notified when you successfully book an office hour
                  </p>
                </div>
              </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className={`text-sm mt-1 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                      Receive email confirmation when you book an office hour session
                    </p>
                  </div>
            ...
            <div className="p-4 sm:p-6">
              <div className="flex items-start gap-3 sm:gap-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <p className={`text-sm mt-1 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                    Get notified when you cancel a booking
                  </p>
                </div>
              </div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className={`text-sm mt-1 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                      Receive email confirmation when you cancel a booking
                    </p>
                  </div>
                  <Mail className={`w-5 h-5 flex-shrink-0 ${
                    preferences.email_on_cancellation
