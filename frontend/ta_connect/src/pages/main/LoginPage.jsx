      ...
      <div className="flex items-center justify-center min-h-[calc(100vh-80px)] p-4">
        <div className={`${isDark ? 'bg-gray-800' : 'bg-white'} p-8 rounded-xl shadow-lg w-full max-w-md`}>
          ...
          <p className={`text-center ${isDark ? 'text-gray-400' : 'text-gray-600'} mb-6`}>
            Login to your TA Connect account
          </p>
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className={`w-full flex items-center justify-center gap-2 ${isDark ? 'bg-gray-700 hover:bg-gray-600' : 'bg-white hover:bg-gray-50'} ${isDark ? 'text-white' : 'text-gray-700'} border ${isDark ? 'border-gray-600' : 'border-gray-300'} py-2 rounded-lg transition`}
            >
