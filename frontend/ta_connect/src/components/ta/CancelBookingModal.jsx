      ...
      >
        ...
        <div className="flex justify-center mb-4">
          <div className={`w-16 h-16 rounded-full flex items-center justify-center ${
            ...
            {isLoading ? (
              <svg className={`w-8 h-8 animate-spin ${isDark ? 'text-red-400' : 'text-red-600'}`} fill="none" viewBox="0 0 24 24">
        ...
        {isLoading && (
          <div className={`mb-6 flex gap-3 p-3 rounded-lg ${
            ...
            <svg className={`w-5 h-5 flex-shrink-0 ${isDark ? 'text-blue-400' : 'text-blue-600'}`} fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
            </svg>
            <p className={`text-xs ${isDark ? 'text-blue-300' : 'text-blue-700'}`}>
              {strings.modals.studentNotified}
            </p>
          </div>
        )}
