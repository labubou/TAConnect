  ...
  const getDeviceSpecificContent = () => {
    switch (deviceType) {
      case 'android':
        return {
          icon: '📱',
          title: 'Install TA Connect App',
          subtitle: 'Add to your Android home screen',
          description: 'Get quick access to office hours, bookings, and notifications.',
          buttonText: '📥 Add to Home Screen'
        };
      case 'ios':
        return {
          icon: '📲',
          title: 'Add TA Connect to Home Screen',
      ...
      default:
        return {
          icon: '💻',
          title: 'Install TA Connect Desktop App',
          subtitle: 'Quick access from your desktop',
          description: 'Install our PWA for faster loading and offline access to your bookings.',
